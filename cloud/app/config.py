...
class Settings:
    ...
    def __init__(self) -> None:
        ...
        self.agent_history_messages: int = _int("AGENT_HISTORY_MESSAGES", 8)
        self.agent_session_ttl_days: int = _int("AGENT_SESSION_TTL_DAYS", 7)
        self.agent_session_cleanup_after_write: bool = _bool(
            "AGENT_SESSION_CLEANUP_AFTER_WRITE", True
        )
